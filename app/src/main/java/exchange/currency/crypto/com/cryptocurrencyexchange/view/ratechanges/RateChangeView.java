...
public class RateChangeView {

    interface View extends BaseViewInteractor{
        // TODO: 11/10/2017  add required View contracts for rate change
    }

    interface Presenter extends BasePresenterInteractor<RateChangeView.View> {
